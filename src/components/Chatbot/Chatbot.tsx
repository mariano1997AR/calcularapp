...
export const Chatbot = ({setMostrarChatbot}:{setMostrarChatbot:(c:boolean) => void}) => {
    ...
    return (
        <>
            <section className=" flex flex-col  shadow rounded completo">
                {/* Barra superior */}
                <section className="barrera-superior  flex justify-between items-center  text-white px-4 py-2 " style={{ background:'#393E46' }}>
                    <span>
